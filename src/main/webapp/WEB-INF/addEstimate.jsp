...
<form:form action="/estimate/create" mode="POST" modelAttribute="estimate">
		...
		<form:input path="floors" class="form-floating" style="width: 300px;"/> <br>
		...
		<input type="submit" class="btn btn-primary" style ="margin-top: 5px;"value="Create"/>
</form:form>
		</div>
	</div>
</div>
